...
- Plugin name: `metabolic-health-agent-custom`
- Rule id: `no-example-identifier`
- Config key: `metabolic-health-agent-custom/no-example-identifier`
...
You should see a lint error from `metabolic-health-agent-custom/no-example-identifier`.
